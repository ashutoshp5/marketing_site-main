            ...
            <ContactItem
              ...
              content={
                <a 
                  ...
                  className="text-gray-600 hover:text-[#FF4A2F] transition-colors duration-200"
...
const ContactItem = ({ icon, title, content }) => (
  <div className="flex items-start space-x-4 group">
    <div className="flex-shrink-0">
      <div className="rounded-full p-3 bg-[#FF4A2F]/10 border border-[#FF4A2F]/20 group-hover:bg-[#FF4A2F]/20 transition-colors duration-200">
        {icon}
      </div>
    </div>
    <div>
